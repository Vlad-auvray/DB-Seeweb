...
<body>
    ...
    <select class="form-select" name="client_id">
        ...
        @endforeach
                    ...
                    <input type="text" class="form-control" name="nom_domaine" placeholder="exemple.bzh">
                </div>
                <div class="md-3">
                    <label class="form-label">Coût annuel en €</label>
                    <input type="number" step="0.01" class="form-control" name="cout_annuel" placeholder="Montant">
                </div>
                <br>
